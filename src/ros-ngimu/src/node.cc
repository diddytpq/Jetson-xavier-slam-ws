...
int main(int argc, char ** argv)
{
    ...
    ros::NodeHandle n;
    imuPub = n.advertise<sensor_msgs::Imu>("/imu/data", 100);
    accelTempPub = n.advertise<sensor_msgs::Temperature>("/ngimu/accel/temperature", 100);
    gyroTempPub = n.advertise<sensor_msgs::Temperature>("/ngimu/gyro/temperature", 100);
