...
(cl:defclass <VescState> (roslisp-msg-protocol:ros-message)
  ((voltage_input
   ...
   (pid_pos_now
    ...
    :initform 0.0)
   (controller_id
    :reader controller_id
    :initarg :controller_id
    :type cl:integer
    :initform 0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VescState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VescState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openrobot_vesc_msgs-msg:<VescState> is deprecated: use openrobot_vesc_msgs-msg:VescState instead.")))
...
(cl:defmethod speed-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:speed-val is deprecated.  Use openrobot_vesc_msgs-msg:speed instead.")
  (speed m))
...
(cl:defmethod charge_drawn-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:charge_drawn-val is deprecated.  Use openrobot_vesc_msgs-msg:charge_drawn instead.")
  (charge_drawn m))

(cl:ensure-generic-function 'charge_regen-val :lambda-list '(m))
(cl:defmethod charge_regen-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:charge_regen-val is deprecated.  Use openrobot_vesc_msgs-msg:charge_regen instead.")
  (charge_regen m))

(cl:ensure-generic-function 'energy_drawn-val :lambda-list '(m))
(cl:defmethod energy_drawn-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:energy_drawn-val is deprecated.  Use openrobot_vesc_msgs-msg:energy_drawn instead.")
  (energy_drawn m))

(cl:ensure-generic-function 'energy_regen-val :lambda-list '(m))
(cl:defmethod energy_regen-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:energy_regen-val is deprecated.  Use openrobot_vesc_msgs-msg:energy_regen instead.")
  (energy_regen m))

(cl:ensure-generic-function 'displacement-val :lambda-list '(m))
(cl:defmethod displacement-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:displacement-val is deprecated.  Use openrobot_vesc_msgs-msg:displacement instead.")
  (displacement m))

(cl:ensure-generic-function 'distance_traveled-val :lambda-list '(m))
(cl:defmethod distance_traveled-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:distance_traveled-val is deprecated.  Use openrobot_vesc_msgs-msg:distance_traveled instead.")
  (distance_traveled m))

(cl:ensure-generic-function 'fault_code-val :lambda-list '(m))
(cl:defmethod fault_code-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:fault_code-val is deprecated.  Use openrobot_vesc_msgs-msg:fault_code instead.")
  (fault_code m))

(cl:ensure-generic-function 'pid_pos_now-val :lambda-list '(m))
(cl:defmethod pid_pos_now-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:pid_pos_now-val is deprecated.  Use openrobot_vesc_msgs-msg:pid_pos_now instead.")
  (pid_pos_now m))

(cl:ensure-generic-function 'controller_id-val :lambda-list '(m))
(cl:defmethod controller_id-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openrobot_vesc_msgs-msg:controller_id-val is deprecated.  Use openrobot_vesc_msgs-msg:controller_id instead.")
  (controller_id m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VescState>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'pid_pos_now))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'controller_id)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VescState>) istream)
  "Deserializes a message object of type '<VescState>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'controller_id) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VescState>))
  ...
  (cl:list 'VescState
    ...
    (cl:cons ':controller_id (controller_id msg))
))
