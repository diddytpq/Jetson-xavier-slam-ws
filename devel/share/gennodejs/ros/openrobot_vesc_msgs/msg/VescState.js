...
class VescState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('controller_id')) {
        this.controller_id = initObj.controller_id
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [controller_id]
    bufferOffset = _serializer.int32(obj.controller_id, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [controller_id]
    data.controller_id = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.controller_id !== undefined) {
      resolved.controller_id = msg.controller_id;
    }
    else {
      resolved.controller_id = 0
    }
